...
Finally, now that we have chosen a basis for $\O$, we can show that although by 
...
Therefore, any octonion algebra is central, i.e. $Z(\O_F) = F\cdot 1_{\O}$, and it follows from Proposition 
